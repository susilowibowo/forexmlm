...
@section('page_header')
    <div class="container-fluid">
        ...
        @can('add', app($dataType->model_name))
            ...
            <a href="{{ route('admin.tree.preview') }}" class="btn btn-success btn-add-new">
                <span>Tree View</span>
            </a>
        @endcan
                            ...
                            <table id="dataTable" class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                            ...
                                            <td>
                                                ...
                                                @else
                                                    ...
                                                    @if ($row->field == 'parent_id')
                                                        {{\App\Models\Member::where('id', $data->{$row->field})->pluck('name')->first()}}
                                                    @else
                                        ...
                                        @endforeach
                                        <td>
                                            {{ \App\Models\Member::calculateBonus($data->id) }}
                                        </td>
                                            ...
                                            @foreach($actions as $action)
                                                ...
                                                @if($data)
                                                        ...
                                                        @can ($action->getPolicy(), $data)
                                                            @if ($action->shouldActionDisplayOnRow($data) && $action->getTitle() != 'Delete')
